...
namespace nana {
namespace effects {
enum class edge_nimbus { none, active = 0x1, over = 0x2 };
...
class bground_transparent : public bground_factory_interface {
public:
...
class bground_blur : public bground_factory_interface {
public:

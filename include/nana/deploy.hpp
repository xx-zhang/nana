...
struct utf8_Error : std::runtime_error {
  static bool use_throw; ///< def { true }; use carefully - it is a global
                         ///< variable !! \todo initialize from a #define ?
...
namespace nana {
inline unsigned make_rgb(unsigned char red, unsigned char green,
                         unsigned char blue) {
